...
- **Sangat penting untuk reliability**: Jangan pakai edge-tts untuk daily automation. Set `TTS_PROVIDER=openai` (paling gampang, auto-split script panjang) atau `xtts` / `piper` + reference di `.env` (lihat QUICKSTART.md)
